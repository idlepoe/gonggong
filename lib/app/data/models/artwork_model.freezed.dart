...
mixin _$Artwork {
  ...
  $ArtworkCopyWith<Artwork> get copyWith =>
      _$ArtworkCopyWithImpl<Artwork>(this as Artwork, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.manageYear, manageYear) ||
                other.manageYear == manageYear) &&
            (identical(other.nameKr, nameKr) || other.nameKr == nameKr) &&
...
abstract mixin class $ArtworkCopyWith<$Res> {
  factory $ArtworkCopyWith(Artwork value, $Res Function(Artwork) _then) =
      _$ArtworkCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      @JsonKey(name: 'prdct_cl_nm', fromJson: _nullToEmptyString)
      ...
      @JsonKey(name: 'matrl_technic', fromJson: _nullToEmptyString)
      String material,
      @JsonKey(name: 'writr_nm', fromJson: _nullToEmptyString) String writer,
      @JsonKey(name: 'main_image', fromJson: _nullToEmptyString)
      String mainImage,
      @JsonKey(name: 'thumb_image', fromJson: _nullToEmptyString)
      String thumbImage,
    ...
    return _then(_self.copyWith(
      ...
      className: null == className
          ...
          : className // ignore: cast_nullable_to_non_nullable
              as String,
      manageYear: null == manageYear
          ? _self.manageYear
          : manageYear // ignore: cast_nullable_to_non_nullable
              as String,
      nameKr: null == nameKr
          ? _self.nameKr
          : nameKr // ignore: cast_nullable_to_non_nullable
              as String,
      nameEn: null == nameEn
          ? _self.nameEn
...
class _Artwork implements Artwork {
  const _Artwork(
      ...
      required this.price});
  factory _Artwork.fromJson(Map<String, dynamic> json) =>
...
abstract mixin class _$ArtworkCopyWith<$Res> implements $ArtworkCopyWith<$Res> {
  factory _$ArtworkCopyWith(_Artwork value, $Res Function(_Artwork) _then) =
      __$ArtworkCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$ArtworkCopyWithImpl<$Res> implements _$ArtworkCopyWith<$Res> {
